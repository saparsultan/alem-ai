  ...
  return (
    <div className="policy">
      <div className="policy__container">
        ...
        <p>
          ZIZ built the Aisha AI app as a Free app. This SERVICE is provided by
          ZIZ at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Aisha AI unless
        ...
        <p>
          ...
          including but not limited to email,fullname,audio,video. The
        ...
        <p>
          ...
          not hesitate to contact us at sayatraykulov@gmail.com.
        </p>
      </div>
    </div>
  );
